...
import 'package:prms/Screens/guestuser_data.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _init() async {
    ...
    log("loggedInUser init $loggedInUser");
  ...
  Widget build(BuildContext context) {
    ...
    log("loggedInUser **** $loggedInUser ()()() ${dummyClaimData.length}");
        ...
        body: RefreshIndicator(
          onRefresh: () async {
            if (loggedInUser == "Test01") {
              ...
              log("loggedinUer on refresh $loggedInUser");
            ...
            children: [
              ...
              loggedInUser == "Test01"
                ...
                child: ListView.builder(
                  itemCount: dummyClaimData.length,
                  itemBuilder: (context, i) {
                    final claim = dummyClaimData[i];
                    ...
                    return Container(
                      ...
                      child: ExpansionTile(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  postModel.claimData![i].claimType,
                                  textScaleFactor:
                                  MediaQuery.of(
                                    context,
                                  ).textScaleFactor,
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  postModel.claimData![i].totalamount,
                                  textScaleFactor:
                                  MediaQuery.of(
                                    context,
                                  ).textScaleFactor,
                        ...
                        children: <Widget>[
                          Column(
                            children: _buildExpandableContent(
                              postModel.claimData![i].claimDataList,
                              postModel,
                              postModel.claimData![i].cid,
                              postModel.claimData![i].claimType,
                            ),
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        {
                          await postModel.getDataDetailOnDD(
                            postModel.claimData![0].claimDataList[0].fin_year,
                          );
                          var opdAmount = postModel.opdDetailModel!.opd;
                          postModel.claimData![selectedOption!].totalamount;
                          print(
                            "postModel.claimData![selectedOption!].totalamount :: ${postModel.claimData![selectedOption!].totalamount}",
                          );
                          int total = int.parse(
                            postModel.claimData![selectedOption!].totalamount,
                          );
                          ...
                          if (opdAmount != null) {
                            if (opdAmount >= total) {
                              postModel.getDataSubmit(context, reqno.toString());
                            } else {
                              DialogUtils.showCustomDialog(
                                context,
                                title: "PRMS",
                                description:
                                "Your Amount Exceeded the remaining Amount",
                                onpositivePressed: () {
                                  Navigator.pop(context);
      ...
      columnContent.add(
        ListTile(
          ...
          leading: GestureDetector(
            onTap: () {
              removeDataDialog(
                claimDataList[i].claimid.toString(),
                cid,
                postModel,
                ...
                if (claimID == "logout" ) {
                  ...
                  if (loggedInUser == "Test01") {
                    final snackBar = SnackBar(
                      content:  Text('Data Deleted Successfully',textScaleFactor: MediaQuery.of(context).textScaleFactor,),
