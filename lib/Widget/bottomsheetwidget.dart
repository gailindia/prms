...
class BottomSheetWidget extends StatefulWidget {
  ...
  BottomSheetWidget({Key? key,required this.content, required this.heading,required this.claimtype,this.systemMedicine,this.otherclaimModel, required this.onpressed}) : super(key: key);
              ...
              showModalBottomSheet(context: context, builder: (context){
                return  Column(
                  children: [
                    ...
                    widget.claimtype == null ?    ListView.builder(
                          ...
                          return  Center(
                            child: GestureDetector(
                                onTap: (){
                                  ...
                                  if(widget.heading!.contains('Patient')){
                                    widget.onpressed(widget.otherclaimModel![index].name!);
                                  }else{
                                    widget.onpressed(widget.otherclaimModel![index].id!);
                                  }
                                ...
                                child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Center(child: Text(widget.otherclaimModel![index].name.toString(),textAlign: TextAlign.center,)),
                                    ))),
                          );
                        }):
                    ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return  Center(
                            child: GestureDetector(
                                onTap: (){
                                  // print("fzrdgxftcgvyhbjkn ${claimtype[index]}");
                                  widget.onpressed(widget.claimtype![index].value!);
                                ...
                                child: Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(widget.claimtype![index].text.toString(),textAlign: TextAlign.center,style: TextStyle(fontSize: 18),),
                                    ))),
                          );
                        }),
                  ],
